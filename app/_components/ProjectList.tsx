            ...
            <div className="container">
                ...
                <div className="group/projects relative" ref={containerRef}>
                    {selectedProject !== null && (
                        <div
                            className="rounded-[35px] max-md:hidden  absolute right-0 top-0 z-[1] pointer-events-none w-[200px] xl:w-[400px] aspect-[16/9] overflow-hidden opacity-0"
                            ref={imageContainer}
                        >
                            {PROJECTS.map((project) => (
                                <Image
                                    ...
                                    height="300"
                                    className={cn(
                                        'absolute inset-0 p-2 transition-all duration-500 w-full h-full object-cover',
                                        {
                                            'opacity-0':
                                                project.slug !==
                                                selectedProject,
